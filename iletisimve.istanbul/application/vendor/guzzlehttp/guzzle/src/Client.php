...
class Client implements ClientInterface
{
    ...
    public function sendAsync(RequestInterface $request, $options = array())
    {
    ...
    public function requestAsync($method, $uri = null, $options = array())
    {
        $options = $this->prepareDefaults($options);
    ...
    public function request($method, $uri = null, $options = array())
    {
        $options[RequestOptions::SYNCHRONOUS] = true;
