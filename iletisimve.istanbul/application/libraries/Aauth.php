...
class Aauth {
	...
	public function __construct() {
		...
		$this->config_vars = $this->CI->config->item('aauth');
			$this->CI->lang->load('aauth',$this->config_vars['language']==''?$this->CI->session->userdata('language'):$this->config_vars['language']=='');
	...
	public function list_users($group_par = FALSE, $limit = FALSE, $offset = FALSE, $include_banneds = FALSE, $sort = FALSE) {
		...
		if ($group_par != FALSE) {
			...
			$this->aauth_db->select('id,email,username,banned,last_login,last_activity,date_created,forgot_exp, remember_time, remember_exp')
